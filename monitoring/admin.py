...
class RoadSegmentAdmin(admin.ModelAdmin):
    list_display = ['id', 'start_latitude', 'start_longitude', 'end_latitude', 'end_longitude', 'length', 'created_at']
...
class SpeedReadingAdmin(admin.ModelAdmin):
    list_display = ['id', 'road_segment', 'average_speed', 'traffic_intensity', 'timestamp', 'created_at']
